...
use App\Tests\DataFixtures\LoadUnmappedData;
...
class RelationLoaderTest extends BaseTest
{
    ...
    {
        parent::setUp();
        $this->loadFixtures([LoadUnmappedData::class]);
        ...
        $this->relationLoader = new RelationLoader($this->em, new NullLogger(), $relationMapper);
