...
namespace App\Api\Client\Brickset;
...
//        $this->options['cache_wsdl'] = WSDL_CACHE_NONE;
    ...
    public function login($username, $password)
    {
        ...
        if ('INVALIDKEY' == $response) {
            return false;
        } elseif (0 === strpos($response, 'ERROR:')) {
            return false;
        }
    ...
    private function checkApiKey()
    {
        ...
        if ('OK' != $this->getSoapClient()->__soapCall('checkKey', [$parameters])->checkKeyResult) {
