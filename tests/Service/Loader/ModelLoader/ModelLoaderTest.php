...
class ModelLoaderTest extends BaseTest
{
    ...
    public function setUp()
    {
        ...
        $this->modelLoader = new ModelLoader($this->em, new NullLogger(), $stlConverter, $relationMapper);
    ...
    /**
     * @expectedException \App\Exception\Loader\MissingContextException
     */
    ...
    /**
     * @expectedException \App\Exception\Loader\LoadingModelFailedException
     */
