 ...
 * @ORM\Entity(repositoryClass="App\Repository\Rebrickable\InventoryRepository")
 */
class Inventory
{
    use IdentityTrait;
     ...
     * @var Set
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\Rebrickable\Set", inversedBy="inventories")
     */
    protected $set;
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Rebrickable\Inventory_Part", mappedBy="inventory")
     */
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Rebrickable\Inventory_Set", mappedBy="inventory")
     */
